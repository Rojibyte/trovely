...
export default function Testimonial() {
  return (
    <section className="py-[80px] bg-(--stone4)">
      <Container>
        <div className="flex flex-col justify-center items-center gap-8 mb-8 m-auto w-[550px]">
          <h4 className="font-sans text-[14px] text-center uppercase text-(--stone1) tracking-[0.15em]">
            Kept by our customers
          </h4>
          <h3 className="font-heading text-2xl leading-[40px] text-center text-(--ink1)">
            &quot;I own three pitchers now. Each one sits somewhere different in
            the house and somehow all three are the piece I reach for.&quot;
          </h3>
          <div className="w-[50px] h-[0.5px] bg-(--stone2)"></div>
