  ...
  return (
    <Container>
      <section className="py-12 flex flex-col gap-8">
        <h1 className="font-heading text-3xl text-(--ink1)">Your Cart</h1>
        ...
        <Link
          href="/checkout"
          className="w-fit self-end rounded-2xl bg-(--action) text-background font-sans text-sm font-medium px-8 py-4 transition-all duration-350 ease-out hover:opacity-90"
        >
          Checkout
        </Link>
      </section>
